...
FFLAGS := -fcray-pointer -fdefault-double-8 -fdefault-real-8 -Waliasing -ffree-line-length-none -fno-range-check -Wno-argument-mismatch -fallow-argument-mismatch
...
LIBS := $(shell pkg-config --libs-only-L netcdf) $(shell pkg-config --libs-only-L mpich) $(shell nf-config --flibs)
LIBS += -lmpich -lfmpich
