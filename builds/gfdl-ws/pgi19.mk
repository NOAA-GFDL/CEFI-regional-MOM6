...
FPPFLAGS += -I/net2/nnz/opt/pgilinux-2019-194-x86-64/linux86-64-llvm/2019/mpi/openmpi-3.1.3/include
FPPFLAGS += -I/net2/nnz/opt/pgilinux-2019-194-x86-64/additions/netcdf-4.4.1.1/include
...
CPPFLAGS = $(INCLUDES)
CPPFLAGS += $(shell pkg-config --cflags-only-I netcdf)
#CPPFLAGS += -I/opt/pgi/18.10/linux86-64/18.10/mpi/openmpi/include
...
LIBS := $(shell pkg-config --libs-only-L netcdf) 
LIBS += -L/net2/nnz/opt/pgilinux-2019-194-x86-64/linux86-64-llvm/2019/mpi/openmpi-3.1.3/lib
LIBS += -lnetcdff -lnetcdf -lz -lmpi -lmpi_mpifh -acc
