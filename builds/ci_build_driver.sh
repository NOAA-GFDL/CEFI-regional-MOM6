...
apptainer exec -B /gpfs -B /ncrc/home2/$USER:/ncrc/home2/$USER -B /autofs/ncrc-svm1_home1/role.medgrp:/autofs/ncrc-svm1_home1/role.medgrp $img bash linux-build.bash -m docker -p linux-intel -t repro -f mom6sis2
