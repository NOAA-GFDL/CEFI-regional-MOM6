...
ncks -d xh,39,39 -v age -A  prog.nc west.nc
...
ncrename -v age,age_segment_001 west.nc
...
ncks -d xh,39,39 -v h -A  prog.nc west.nc
ncrename -v h,dz_age_segment_001 west.nc
...
ncks -d xh,80,80 -v age -A  prog.nc east.nc
...
ncrename -v age,age_segment_002 east.nc
...
ncks -d xh,80,80 -v h -A  prog.nc east.nc
ncrename -v h,dz_age_segment_002 east.nc
