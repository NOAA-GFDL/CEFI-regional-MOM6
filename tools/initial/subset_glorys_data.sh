...
# How to use
#./subset_glorys_data.sh -u USERNAME -p PASSWORD -o "./datasets/glorys/daily" -x -100 -X -35 -y 0 -Y 60 -s "1993-01-01" -e "1993-01-01"
...
while [[ "$startDate" != "$endDate" ]]; do
    ...
    command="copernicusmarine subset -i $productId $login \
